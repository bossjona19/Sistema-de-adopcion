const TABS      = ['overview', 'menores', 'familias', 'casos', 'usuarios', 'papelera', 'bitacora', 'errores', 'config'];
const TAB_NAMES = { overview: 'Dashboard', menores: 'Niños', familias: 'Familias', casos: 'Casos', usuarios: 'Usuarios', papelera: 'Papelera', bitacora: 'Bitácora', errores: 'Monitoreo', config: 'Configuración' };
let _onInit     = null;
